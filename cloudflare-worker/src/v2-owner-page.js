...
(function(){
  ...
  function renderCandidate(row){return '<div class="row"><div><div class="main">'+esc(row.selected_team)+' · '+esc(row.side)+'</div><div class="meta">'+esc(row.opponent)+' · '+esc(row.minute)+"' · "+esc(row.score)+'</div></div><div class="good">'+esc(row.momentum==null?'warming':row.momentum+'%')+'</div><div class="meta">'+esc(row.market)+' · AH '+esc(row.ah_line==null?'—':row.ah_line)+'</div><div class="meta">streak '+esc(row.streak)+'</div></div>'}
  function renderSignal(row){return '<div class="row"><div><div class="main">'+esc(row.selected_team||row.selection)+' · '+esc(row.market)+'</div><div class="meta">'+esc(row.home)+' vs '+esc(row.away)+' · '+esc(row.minute)+"'</div></div><div class="good">'+esc(row.confidence)+'%</div><div class="meta">'+esc(ago(row.created_at))+'</div><div class="meta">PAPER</div></div>'}
