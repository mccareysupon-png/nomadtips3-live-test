...
async function noStoreUiAsset(request, env) {
  ...
  if (path.startsWith('/settings')) headers.set('x-nomad-settings-revision', '343-full-market-settings-v1');
  if (path === '/index.html' || path === '/live.js' || path === '/full-odds-main-343.js' || path === '/full-market-event-trigger-343.js' || path.startsWith('/event-flow-343')) headers.set('x-nomad-live-revision', '343-live-full-market-settings-v1');
...
export default {
  async fetch(request, env) {
    ...
    if (request.method === 'GET' && (
      url.pathname === '/index.html' || url.pathname === '/live.js' || url.pathname === '/full-odds-main-343.js' || url.pathname === '/full-market-event-trigger-343.js' || url.pathname === '/event-flow-343.js' || url.pathname === '/event-flow-343.css' ||
      url.pathname === '/settings.html' || url.pathname === '/settings.js' || url.pathname === '/settings.css' ||
